...
public abstract class Market {
    ...
    final static String INSUFFICIENT_ASSETS_WARNING = "You don't have any tickets to sell.";
    final static String TOO_MANY_SALES_WARNING = "You have already placed sell offers for all your tickets.  Please delete a sell offer before submitting a new one";
